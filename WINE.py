...
plt.xlabel('Accuracy')
plt.title('WINE: Accuracy without Standardization')
...
plt.yticks(y_pos, objects)
plt.xlabel('Accuracy')
plt.title('WINE: Accuracy with Standardization')
...
plt.yticks(y_pos, objects)
plt.xlabel('F1')
plt.title('WINE: F1 without standardization')
...
plt.yticks(y_pos, objects)
plt.xlabel('F1')
plt.title('WINE: F1 with standardization')
...
plt.yticks(y_pos, objects)
plt.xlabel('MSE')
plt.title('WINE: MSE without standardization')
...
plt.yticks(y_pos, objects)
plt.xlabel('MSE')
plt.title('WINE: MSE with standardization')
...
plt.title('WINE: Hamming Loss without standardization')
...
plt.yticks(y_pos, objects)
plt.xlabel('Hamming Loss')
plt.title('WINE: Hamming Loss with standardization')
